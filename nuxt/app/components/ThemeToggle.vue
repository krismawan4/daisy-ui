  ...
  <div>
    <div class="dropdown dropdown-end">
      ...
      <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-64 max-h-96 overflow-y-auto">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('dark')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('cupcake')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('bumblebee')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('emerald')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('corporate')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('synthwave')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('retro')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('cyberpunk')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('valentine')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('halloween')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('garden')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('forest')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('aqua')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('lofi')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('pastel')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('fantasy')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('wireframe')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('black')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('luxury')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('dracula')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('cmyk')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('autumn')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('business')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('acid')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('lemonade')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2 [&amp;_svg]:visible" @click="setTheme('night')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('coffee')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('winter')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('dim')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('nord')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('sunset')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('caramellatte')" data-act-class="[&amp;_svg]:visible">
            <div data-theme="caramellatte" class="bg-base-100 grid shrink-0 grid-cols-2 gap-0.5 rounded-md p-1 shadow-sm">
              <div class="bg-base-content size-1 rounded-full"></div>
              <div class="bg-primary size-1 rounded-full"></div>
              <div class="bg-secondary size-1 rounded-full"></div>
              <div class="bg-accent size-1 rounded-full"></div>
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('abyss')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <button class="gap-3 px-2" @click="setTheme('silk')" data-act-class="[&amp;_svg]:visible">
        ...
        <li>
          <a href="/theme-generator/"
            ...
            <div class="grow text-sm font-bold">Buat tema Anda!</div></a
          >
        </li>
      </ul>
    </div>
